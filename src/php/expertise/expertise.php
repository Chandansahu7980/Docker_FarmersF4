...
<body>
    ...
    ?>
        ...
        <div class="content" id="tableContent">
                    ...
                    <table cellspacing='0' border="1">
                        ...
                        ?>
                            <tr>
                                ...
                                ?>
                                    <td><a href="viewqueryAnswerPage.php?query_id=<?php echo $row['id']; ?>" style="color:green; font-weight:bold">View Answer</a>
                                    </td>
                                <?php
                                }
                                ?>
            ...
            if (isset($_POST['logout'])) {
                ...
                session_start();
                session_destroy();
                header("Location: expertiseLogin.php");
                exit();
            }
            ?>
    ...
    <?php
        ...
        echo "<script>alert('You must be logged in to access this page.');window.location.href = 'expertiseLogin.php';</script>";
        // exit();
    }
    ob_end_flush();
    ?>
